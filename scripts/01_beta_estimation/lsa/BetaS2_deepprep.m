%% BetaS2_deepprep - Estimate LSA betas from DeepPrep derivatives
...
% Paths
% -------------------------------------------------------------------------
deepprep_dir = '/orange/ruogu.fang/pateld3/data/deepprep';
tmp_base     = '/orange/ruogu.fang/pateld3/data/deepprep-tmp';
betas_base   = '/orange/ruogu.fang/pateld3/data/deepprep-betas';
